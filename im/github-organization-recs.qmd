...
It may seem simplest to simply make a new GitHub _user_ account for your site (or use your existing personal user account if you have one) but creating a 'true' organization confers several benefits that make it worthwhile:
...
2. Add all relevant organization members to that team
    - Note that they _must_ be organization members
3. Add all relevant repositories to that _team_
