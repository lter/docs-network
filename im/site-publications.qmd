...
The LTER Network maintains a [Zotero group library](https://www.zotero.org/groups/2055673/lter_network/library) where we track publications (journal articles, reports, and theses) that have been made possible through LTER funding, collaborations, and activities. The [publications web page](https://lternet.edu/bibliography/) on the LTER Network website draws its data from the Zotero library.

- The LNO updates the library monthly with publications found via a Web of Science alert based on grant numbers listed in funding acknowledgements.
-  Our search strategy does not catch theses or publications where authors have not acknowledged your site by grant number. Therefore, sites should provide a list of other publications that fit the inclusion criteria **at least annually**. The easiest way to do this is for sites to maintain their own Zotero library with a collection of products that meet the inclusion criteria. When you have an update to share, let the LNO know and we will copy over any publications added since the last update. If you do not use Zotero, the LNO can also accept a bibtex export from your reference manager.

## Inclusion criteria for the Network bibliography:
...
- Maps
- Software
- Peer-reviewed conference papers (not posters or presentations)
- Published reports
- Patents
- Master's and PhD theses

that have been published during the term of NSF funding for the site with LTER funding, LTER personnel, or based on LTER data or experiments.  

### Do not include

- Work that was simply inspired by proximity to LTER research.
...
- Abstracts for conference presentations or posters. These are legitimate products, but in the context of a decades-long program, they are relatively ephemeral, and make it look like we are inflating our numbers.
...
Find full details on the definition of item types and the required and optional fields on the [biblio fields](https://lter.github.io/docs-network/im/biblio-fields.html) page.

:::

## Zotero Updates

1. Set up a Zotero account and a group library. The [Zotero Best Practices Guide](https://docs.google.com/document/d/1aaM2htz4rJLGo5XFuk88AWxO_sWmZl2TY0EEA7q7LMY/edit?tab=t.0#heading=h.41s6zixhzhd9) serves as a useful orientation. 
...
7. Invite the LNO staff (lno@lternet.edu or downs@nceas.ucsb.edu) to your group library.
...
Zotero is becoming the most common system for maintaining a publication database at LTER sites, but if your site prefers EndNote or a custom database, you may provide your update in the form of a bibtex file. See instructions [here](bibtex.html).
...
- **Q:** What's the point of all this?
    ...
    - [Collaboration across Time and Space in the LTER Network](https://doi.org/10.1093/biosci/biaa014). March 2020. Tian-Yuan Huang, Martha R Downs, Jun Ma, Bin Zhao. BioScience, Volume 70, Issue 4, Pages 353–364, doi: 10.1093/biosci/biaa014
    - [Evolution of Collaboration within the US Long Term Ecological Research Network](https://doi.org/10.1525/bio.2010.60.11.9). December 2010. Jeffrey C. Johnson, Robert R. Christian, James W. Brunt, Caleb R. Hickman, Robert B. Waide. BioScience, Volume 60, Issue 11, Pages 931–940, doi: 10.1525/bio.2010.60.11.9
